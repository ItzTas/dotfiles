        ...
        <ui:param name="'actionsContent'">
            <div class="aui-buttons">
                ...
                <ww:if test="/systemAdministrator == true">
                    <button id="import-workflow-trigger" class="aui-button aui-dropdown2-trigger" aria-owns="import-dropdown" aria-haspopup="true"><ww:text name="'admin.workflows.import'"/></button>
                </ww:if>
                <ww:else>
                    ...
                    <div id="active-workflows-val">
                        ...
                        <table id="active-workflows-table" class="aui aui-table-rowhover list-workflow-table">
                            ...
                            <tr>
                                ...
                                <th class="workflow-operations"><ww:text name="'common.words.actions'"/></th>
                            </tr>
                            </thead>
                            <tbody>
                            <ww:iterator value="activeWorkflows" status="'status'">
                                ...
                                <td class="workflow-operations" data-cell-type="operations">
                                    <ul class="operations-list">
                                        <li><a data-operation=view data-id="steps_<ww:property value="mode"/>_<ww:property value="name"/>" href="<ww:url page="ViewWorkflowSteps.jspa"><ww:param name="'workflowMode'" value="mode" /><ww:param name="'workflowName'" value="name" /></ww:url>"><ww:text name="'common.words.view'"/></a></li>
                                        <ww:if test="./systemWorkflow == false">
                                            <li><a data-operation="edit" data-id="edit_<ww:property value="mode"/>_<ww:property value="name"/>" href="<ww:url page="EditWorkflowDispatcher.jspa"><ww:param name="'wfName'" value="name" /></ww:url>" class="clickonce"><ww:text name="'common.words.edit'"/></a></li>
                                        </ww:if>
                                        <li><a data-operation="copy" class="trigger-dialog" data-id="copy_<ww:property value="name"/>" href="<ww:url page="CloneWorkflow!default.jspa"><ww:param name="'workflowMode'" value="mode" /><ww:param name="'workflowName'" value="name" /></ww:url>"><ww:text name="'common.words.copy'"/></a></li>
                                    </ul>
                                </td>
                                </tr>
                            </ww:iterator>
                            ...
                            <tr data-workflow-name="<ww:property value="name"/>">
                                ...
                                <td class="workflow-operations" data-cell-type="operations">
                                    <ul class="operations-list">
                                        ...
                                        <ww:if test="./systemWorkflow == false">
                                            <li><a data-operation="edit" data-id="edit_<ww:property value="mode"/>_<ww:property value="name"/>" href="<ww:url page="EditWorkflowDispatcher.jspa"><ww:param name="'wfName'" value="name" /></ww:url>"><ww:text name="'common.words.edit'"/></a></li>
                                        </ww:if>
                                        <li><a data-operation="copy" class="trigger-dialog" data-id="copy_<ww:property value="name"/>" href="<ww:url page="CloneWorkflow!default.jspa"><ww:param name="'workflowMode'" value="mode" /><ww:param name="'workflowName'" value="name" /></ww:url>"><ww:text name="'common.words.copy'"/></a></li>
                                        <ww:if test="./editable == true">
                                            <ww:if test="draftWorkflow == true || /hasSchemesForWorkflowIncludingDrafts(.) == false">
                                                <li><a data-operation="delete" class="trigger-dialog" data-id="del_<ww:property value="name"/>" href="<ww:url page="DeleteWorkflow.jspa"><ww:param name="'workflowMode'" value="mode" /><ww:param name="'workflowName'" value="name" /></ww:url>"><ww:text name="'common.words.delete'"/></a></li>
                                            </ww:if>
                                        </ww:if>
                                    </ul>
                                </td>
