        ...
        <tr>
            <td>
                <span data-scheme-field="name" class="field-name">
                    <ww:if test="./type">
                        <a href="<ww:url page="/secure/admin/ViewIssueFields.jspa" ><ww:param name="'fieldId'" value="./id"/> </ww:url>" title="<ww:text name="'admin.issuefields.fieldconfigurations.edit.field.properties'"/>"><ww:property value="./name"/></a>
                    </ww:if>
                    <ww:else>
            ...
            <td>
                ...
                <ww:if test="./type">
                    <li><a id="configure-<ww:property value="./name"/>" href="<ww:url page="/secure/admin/ViewIssueFields.jspa" ><ww:param name="'fieldId'" value="./id"/> </ww:url>" title="<ww:text name="'admin.issuefields.fieldconfigurations.edit.field.properties'"/>"><ww:text name="'admin.common.words.configure'"/></a></li>
                </ww:if>
                <ww:else>
