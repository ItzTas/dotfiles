...
<page:applyDecorator name="jiraform">
            ...
            <aui:component template="auimessage.jsp" theme="'aui'">
                ...
                <aui:param name="'messageHtml'">
                    <p><ww:text name="'admin.issuefields.fieldconfigurations.renderer.warning'">
                            <ww:param name="'value0'"><a href="<%= request.getContextPath() %><ww:text name="/effectedIssuesQueryString"/>"><ww:property value="/effectedIssuesCount"/></ww:param>
    ...
    <ui:component name="'fieldId'" template="hidden.jsp" />
