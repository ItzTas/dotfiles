                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="cell-type-value">
                            ...
                            <span>(<a href="<ww:url value="'ViewSystemInfo!garbageCollection.jspa'" />" id="forceGarbageCollectionLink" ><ww:text name="'admin.systeminfo.force.garbage.collection'"><ww:param name="value0">garbage collection</ww:param></ww:text></a>)</span>
                        </td>
                    </tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="cell-type-value">
                            ...
                            %>
                            <ww:property value="/extendedSystemInfoUtils/backupLocation" />
                            <% } else {
