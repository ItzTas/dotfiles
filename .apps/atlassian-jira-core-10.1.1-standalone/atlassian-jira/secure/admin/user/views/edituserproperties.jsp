                    ...
                    <tr>
                        ...
                        <td>
                            <ul class="operations-list">
                                <li><a class="trigger-dialog" data-id="edit_<ww:property value="key"/>" href="<ww:url page="EditUserProperty.jspa"><ww:param name="'name'" value="user/name" /><ww:param name="'key'" value="key" /></ww:url>"><ww:text name="'admin.common.words.edit'"/></a></li>
                                <li><a class="trigger-dialog" href="<ww:url page="DeleteUserProperty!default.jspa"><ww:param name="'name'" value="user/name" /><ww:param name="'key'" value="key"/></ww:url>" data-id="delete_<ww:property value="key"/>"><ww:text name="'admin.common.words.delete'"/></a></li>
                            </ul>
                        </td>
                    </tr>
                </ww:iterator>
