            ...
            <ww:iterator value="currentPage" status="'status'">
                <tr class="vcard user-row" data-focused="<ww:property value="/userFocused(.)"/>" data-user="<ww:property value="name"/>">
                    <td data-cell-type="fullname">
                        <a id="<ww:property value="id"/>" rel="<ww:property value="name"/>" class="user-hover user-avatar" href="<ww:url page="ViewUser.jspa"><ww:param name="'name'" value="name"/></ww:url>">
                    ...
                    <td data-cell-type="operations">
                        <ww:if test="/remoteUserPermittedToEditSelectedUser(.) == true">
                            <a class="aui-button aui-button-link trigger-dialog edit-profile-link" id="edituser_link_<ww:property value="id"/>" href="<ww:url page="EditUser!default.jspa"><ww:param name="'editName'" value="name" /><ww:param name="'returnUrl'" value="'UserBrowser.jspa'" /></ww:url>">
                                <ww:text name="'common.words.edit'"/>
                            </a>
                        </ww:if>
                        <a href="#user-actions-<ww:property value="id"/>" aria-owns="user-actions-<ww:property value="id"/>" aria-haspopup="true" class="aui-button aui-button-subtle aui-button-compact aui-dropdown2-trigger aui-dropdown2-trigger-arrowless aui-style-default details-button">
                            <span class="aui-icon aui-icon-small aui-iconfont-more">
                                <ww:text name="'common.words.actions'"/>
                            </span>
                        </a>
                        <div id="user-actions-<ww:property value="id"/>" class="aui-dropdown2 aui-style-default">
                            <ul class="aui-list-truncate">
                                <ww:if test="/remoteUserPermittedToEditSelectedUsersGroups(.) == true">
                                    <li><a class="trigger-dialog editgroups_link" id="editgroups_<ww:property value="id"/>" href="<ww:url page="EditUserGroups!default.jspa"><ww:param name="'name'" value="name" /><ww:param name="'returnUrl'" value="'UserBrowser.jspa'" /></ww:url>">
                                        <ww:text name="'admin.userbrowser.actions.edit.groups'"/>
                                    </a></li>
                                </ww:if>
                                <li><a id="projectroles_link_<ww:property value="id"/>" href="<ww:url page="ViewUserProjectRoles!default.jspa"><ww:param name="'name'" value="name" /><ww:param name="'returnUrl'" value="'UserBrowser.jspa'" /></ww:url>">
                                    <ww:text name="'admin.userbrowser.actions.view.project.roles'"/>
                                </a></li>
                                <ww:if test="/canAnonymizeUser(.) == true">
                                    <li><a id="anonymizeuser_link_<ww:property value="id"/>" href="<ww:url page="AnonymizeUser!default.jspa"><ww:param name="'name'" value="name" /></ww:url>">
                                        <ww:text name="'admin.userbrowser.actions.anonymize.user'"/>
                                    </a></li>
                                </ww:if>
                                <ww:if test="/remoteUserPermittedToEditSelectedUser(.) == true">
                                    <li><a class="trigger-dialog" id="deleteuser_link_<ww:property value="id"/>" href="<ww:url page="DeleteUser!default.jspa"><ww:param name="'name'" value="name" /><ww:param name="'returnUrl'" value="'UserBrowser.jspa'" /></ww:url>">
