...
<body>
                <page:applyDecorator id="edit-entity" name="auiform">
                    <page:param name="cssClass">js-filter-form-edit</page:param>
                    ...
                    <page:param name="displayWarnings">true</page:param>
                    ...
                    <ww:if test="/showShares == true">
                        <ww:component name="'shares'" label="text('common.sharing.viewers')" template="edit-share-types.jsp" theme="'aui'">
                            <ww:param name="'shareTypeList'" value="/viewTypes"/>
                            <ww:param name="'editEnabled'" value="/editEnabled"/>
                            <ww:param name="'dataString'" value="/jsonString"/>
                            <ww:param name="'mode'" value="'viewers'"/>
                            <ww:param name="'submitButtonId'">edit-entity-submit</ww:param>
                        </ww:component>

                        <ww:if test="/showEditors == true">
                            <ww:component name="'shares'" label="text('common.sharing.editors')" template="edit-share-types.jsp" theme="'aui'">
                                <ww:param name="'shareTypeList'" value="/editTypes"/>
                                <ww:param name="'editEnabled'" value="/editEnabled"/>
                                <ww:param name="'dataString'" value="/jsonString"/>
                                <ww:param name="'mode'" value="'editors'"/>
                                <ww:param name="'submitButtonId'">edit-entity-submit</ww:param>
                            </ww:component>
                        </ww:if>
                    </ww:if>
