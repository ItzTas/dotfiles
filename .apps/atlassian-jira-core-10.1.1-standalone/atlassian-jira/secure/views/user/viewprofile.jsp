...
<head>
    <%
        ...
        webResourceManager.requireResource("jira.webresources:profile");
    %>
    ...
    <header class="aui-page-header">
        <div class="aui-page-header-inner">
            ...
            <div class="aui-page-header-main">
                <h1 id="up-user-title"><span id="up-user-title-name"><ww:property value="user/displayName"/></span><ww:if test="user/active == false"> (<ww:text name="'admin.common.words.inactive'"/>)</ww:if></h1>
            </div>
