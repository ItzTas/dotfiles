AJS.test.require("jira.webresources:util-lite", function () {
  ...
  function stubDiv() {
    ...
    Object.defineProperty(divStub, "innerText", {
      set: innerTextStub
    });
    Object.defineProperty(divStub, "textContent", {
      set: textContentStub
    });
    return divStub;
  }
  ...
  test("#readText set element's text using innerText in IE", function () {
    this.context.mock('jira/util/navigator', {
      isIE: function isIE() {
        return true;
      }
    });
  ...
  test("#handleSpaceEnter should call the callback on Space or Enter, but ignore other keypresses", function () {
    ...
    Assistive.handleSpaceEnter(new KeyboardEvent('keydown', {
      key: ' '
    }), callback);
  ...
  test("#handleClickSpaceEnter should call the callback on mouse click, Space and Enter, but ignore other keypresses", function () {
    ...
    Assistive.handleClickSpaceEnter(new KeyboardEvent('keydown', {
      key: ' '
    }), callback);
