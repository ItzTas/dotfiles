AJS.test.require(["jira.webresources:dialogs"], function () {
  ...
  var FormDialog2 = require('jira/dialog/form-dialog2');
  ...
  module("SmartAjax.showWebSudoDialog", {
    ...
    setup: function setup() {
      ...
      this.sandbox.stub(FormDialog2.prototype, "show");
      this.sandbox.stub(FormDialog2.prototype, "hide");
      this.sandbox.stub(FormDialog2.prototype, "setContent");
      this.sandbox.stub(FormDialog2.prototype, "init", function (options) {
        this.options = options || {};
        lastDialog = this;
      });
      FormDialog2.prototype.triggerHide = function (reason) {
  ...
  function assertWebSudoDialogSuccess(options) {
    ...
    ok(dialog.setContent.calledWith(xhr.responseText, true), "Dialog content reset.");
  ...
  var assertWebSudoDialogCancelled = function assertWebSudoDialogCancelled(reason) {
  ...
  test("success with delegating handler", function () {
    ...
    var status = "something";
    var result = {};
    this.webSudo.handleWebSudoError(options, {
      success: success
    }, xhr, status, result);
    ok(this.dialog.calledOnce, "Delgate to showWebSudoDialog");
    var dialogOptions = this.dialog.args[0][0];
