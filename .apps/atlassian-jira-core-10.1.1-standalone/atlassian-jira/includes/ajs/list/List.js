  ...
  return Control.extend({
    ...
    _getDefaultOptions: function _getDefaultOptions() {
      return {
        ...
        // match start of words, including after '('
        ...
        prioritizeExactMatches: false,
        // Whether to move exact matches to the top of the list
    ...
    _makeResultDiv: function _makeResultDiv(data, query) {
      var $fixedContainer = jQuery("<div class=\"aui-list-fixed\" role=\"".concat(this.options.rootRole, "\">"));
      var $resultsContainer = jQuery("<div class=\"aui-list-scroll\" tabindex=\"-1\" role=\"".concat(this.options.rootRole, "\" id=\"").concat(this.options.listId, "\">"));
      var instance = this;
      var ungrouped = [];
    ...
    _renders: {
      suggestion: function suggestion(descriptor, replacementText) {
        ...
        var listElem = jQuery("<li class=\"aui-list-item\"><".concat(this.options.listItemTag, " class=\"aui-list-item-link\" role=\"none\" aria-selected=\"false\" /></li>")).attr({
          "id": itemId + '-' + globalItemId
        });
        var linkElem = listElem.children();
        linkElem.attr({
          "role": this.options.suggestionRole,
          "id": "".concat(itemId, "-").concat(globalItemId, "-link")
        });
