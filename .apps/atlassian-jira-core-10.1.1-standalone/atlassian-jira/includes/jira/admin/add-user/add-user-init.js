require(["jira/admin/application-selector", "jira/skate", "jquery", "aui/inline-dialog2",
//Initialise the inlineDialog2. This is all that is required
"aui/form-notification" //Initialise form notifications. This is all that is required
], function (ApplicationSelector, skate, $) {
  'use strict';
