AJS.test.require(["jira.webresources:jira-events", "jira.webresources:ajs-underscorejs-amd-shim", "jira.webresources:jira-admin-analytics"], function () {
  ...
  test("Select workflow edit/view mode", function () {
    this.createClickAssert("<a class='workflow-view-toggle' data-mode='diagram' href='#'></a>", "administration.workflow.selectmode", {
      mode: "diagram",
      edit: false
    });
    this.createClickAssert("<a class='workflow-view-toggle' data-mode='text' href='#'></a>", "administration.workflow.selectmode", {
      mode: "text",
      edit: false
    });
    this.createClickAssert("<a class='workflow-edit-toggle' data-mode='diagram' href='#'></a>", "administration.workflow.selectmode", {
      mode: "diagram",
      edit: true
    });
    this.createClickAssert("<a class='workflow-edit-toggle' data-mode='text' href='#'></a>", "administration.workflow.selectmode", {
      mode: "text",
      edit: true
    });
  });
  test("Edit workflow in text mode", function () {
    ...
    function assertTextModeEditEvent(triggerId, action, object) {
      instance.createClickAssert("<a id='" + triggerId + "' href='#'></a>", "administration.workflow.edit", {
        mode: "text",
        action: action,
        object: object
      });
  ...
  test("Edit workflow in diagram mode", function () {
    ...
    function assertDiagramEditEvent(action, object) {
      Events.trigger("wfd-edit-action", {
        action: action,
        object: object
      });
      instance.assertEvent("administration.workflow.edit", {
        mode: "diagram",
        action: action,
        object: object
      });
  ...
  test("View workflow on workflow scheme edit page", function () {
    ...
    this.assertEvent("administration.workflowscheme.viewworkflow", {
      mode: "text"
    });
