AJS.test.require(["jira.webresources:application-role-labels"], function () {
  ...
  require(["jira/admin/application/group-labels-store"], function (GroupLabelStore) {
    ...
    test("it will trigger listener", function () {
    ...
    test("callback not fired after removing handler", function () {
      var fetchLabels = this.sandbox.stub(GroupLabelStore, "fetchLabels");
      var callback1 = this.sandbox.stub();
