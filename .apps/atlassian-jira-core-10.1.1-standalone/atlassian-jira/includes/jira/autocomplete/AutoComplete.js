      ...
      */
      ...
      addMultiSelectAdvice: function addMultiSelectAdvice(delim) {
        ...
        var alertUserValueAlreadyExists = function alertUserValueAlreadyExists(val) {
          ...
          if (!alertUserValueAlreadyExists.isAlerting) {
            ...
            var userAlert = jQuery(document.createElement("div")).css({
              "float": "left",
              display: "none"
            }).addClass("warningBox").html("Oops! You have already entered the value <em>" + val + "</em>").appendTo(that.field.parent()).show("fast", function () {
      ...
      addDropdownAdvice: function addDropdownAdvice() {
        ...
        jQuery.aop.after({
          ...
          this.dropdownController = JIRA.Dropdown.AutoComplete({
            target: this,
