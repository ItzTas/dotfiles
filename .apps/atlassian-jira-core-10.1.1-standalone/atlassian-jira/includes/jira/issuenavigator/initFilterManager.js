require(['jira/util/events', 'jira/util/events/types', 'jira/util/events/reasons', 'jira/autocomplete/user-autocomplete', 'jira/common/page', 'jira/tabs/tab-manager', 'jira/dialog/form-dialog2', 'jira/field/favourite-picker', 'wrm/context-path', 'jquery'], function (Events, Types, Reasons, UserAutoComplete, Page, TabManager, FormDialog2, FavouritePicker, wrmContextPath, $) {
  "use strict";
