define('jira/dialog/init-non-dashboard-dialogs', ['jira/dialog/dialog-register', 'jira/dialog/dialog-util', 'jira/dialog/form-dialog2', 'jira/dialog/labels-dialog', 'jira/dialog/link-issue-dialog-factory', 'jira/dialog/screenshot-window', 'jira/issuenavigator/issue-navigator', 'jquery', 'exports'], function (DialogRegister, DialogUtil, FormDialog2, LabelsDialog, LinkIssueDialogFactory, ScreenshotWindow, IssueNavigator, jQuery, exports) {
  'use strict';
  ...
  exports.init = function () {
    ...
    DialogRegister.deleteIssue = new FormDialog2({
    ...
    DialogRegister.archiveIssue = new FormDialog2({
    ...
    DialogRegister.restoreIssue = new FormDialog2({
    ...
    DialogRegister.cloneIssue = new FormDialog2({
    ...
    DialogRegister.assignIssue = new FormDialog2({
      id: "assign-dialog",
    ...
    DialogRegister.assignIssueToMe = new FormDialog2({
      id: "assign-dialog",
    ...
    DialogRegister.logWork = new FormDialog2({
      id: "log-work-dialog",
    ...
    DialogRegister.attachFile = new FormDialog2({
    ...
    DialogRegister.manageAttachment = new FormDialog2({
    ...
    DialogRegister.comment = new FormDialog2({
    ...
    DialogRegister.editComment = new FormDialog2({
      type: "ajax",
      id: "edit-comment",
    ...
    DialogRegister.editLogWork = new FormDialog2({
    ...
    DialogRegister.deleteLogWork = new FormDialog2({
    ...
    DialogRegister.deleteComment = new FormDialog2({
      type: "ajax",
    ...
    DialogRegister.watchIssue = new FormDialog2({
      ajaxOptions: DialogUtil.getDefaultAjaxOptions,
      onSuccessfulSubmit: DialogUtil.storeCurrentIssueIdOnSucessfulSubmit,
      delayShowUntil: DialogUtil.BeforeShowIssueDialogHandler.execute,
    ...
    DialogRegister.stopWatchingIssue = new FormDialog2({
      ajaxOptions: DialogUtil.getDefaultAjaxOptions,
      onSuccessfulSubmit: DialogUtil.storeCurrentIssueIdOnSucessfulSubmit,
      delayShowUntil: DialogUtil.BeforeShowIssueDialogHandler.execute,
    ...
    DialogRegister.addVoteForIssue = new FormDialog2({
      ajaxOptions: DialogUtil.getDefaultAjaxOptions,
      onSuccessfulSubmit: DialogUtil.storeCurrentIssueIdOnSucessfulSubmit,
      delayShowUntil: DialogUtil.BeforeShowIssueDialogHandler.execute,
    ...
    DialogRegister.removeVoteForIssue = new FormDialog2({
      ajaxOptions: DialogUtil.getDefaultAjaxOptions,
      onSuccessfulSubmit: DialogUtil.storeCurrentIssueIdOnSucessfulSubmit,
      delayShowUntil: DialogUtil.BeforeShowIssueDialogHandler.execute,
