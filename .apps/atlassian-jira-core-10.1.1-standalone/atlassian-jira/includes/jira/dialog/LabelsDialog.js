define('jira/dialog/labels-dialog', ['jira/dialog/form-dialog2', 'jira/issue', 'jira/issuenavigator/issue-navigator', 'jira/util/events', 'jira/util/events/types', 'wrm/context-path', 'jquery'], function (FormDialog2, Issue, IssueNavigator, Events, Types, wrmContextPath, jQuery) {
  'use strict';
