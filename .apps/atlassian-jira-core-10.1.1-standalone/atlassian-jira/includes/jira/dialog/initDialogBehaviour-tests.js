AJS.test.require(["jira.webresources:jira-global"], function () {
  ...
  require(['jquery', 'jira/dialog/dialog-register', 'jira/dialog/form-dialog2', 'jira/dialog/init-dialog-behaviour', 'jira/issue'], function ($, DialogRegister, FormDialog2, DialogBehaviour, Issue) {
    ...
    test("Non Issue Dialog will not prevent beforeShow event", function () {
      DialogRegister.testDialog = new FormDialog2();
