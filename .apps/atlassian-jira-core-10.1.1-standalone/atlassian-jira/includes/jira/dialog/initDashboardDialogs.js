define('jira/dialog/init-dashboard-dialogs', ['jira/dialog/dialog-register', 'jira/dialog/form-dialog', 'jquery', 'exports'], function (DialogRegister, FormDialog, jQuery, exports) {
  'use strict';
