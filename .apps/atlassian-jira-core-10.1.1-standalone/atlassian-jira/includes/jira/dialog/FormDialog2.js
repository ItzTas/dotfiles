define('jira/dialog/form-dialog2', ['jira/util/formatter', 'jira/dialog/dialog2', 'jira/flag', 'jira/message', 'jira/ajs/ajax/smart-ajax', 'jira/focus/set-focus', 'jira/util/browser', 'jira/util/events', 'jquery', 'jira/libs/parse-uri'], function (formatter, Dialog2, Flag, Messages, SmartAjax, SetFocus, Browser, Events, jQuery, parseUri) {
  'use strict';
    ...
    decorateContent: function decorateContent() {
      ...
      this.$form.submit(function (e) {
        ...
        if (!event.isDefaultPrevented()) {
          ...
          var submitButtons = jQuery(':submit', instance);
      ...
      $cancel.click(function (e) {
        ...
        instance.hide(true, {
          reason: Dialog2.HIDE_REASON.cancel
        });
        e.preventDefault();
      });
      ...
      this.moveFooterToDialog2($footerContainer);
