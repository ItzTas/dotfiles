define('jira/dialog/init-workflow-transition-dialogs', ['jira/dialog/dialog-register', 'jira/dialog/dialog-util', 'jira/dialog/form-dialog2', 'aui/tabs', 'jquery', 'exports', 'jira/libs/parse-uri'], function (DialogRegister, DialogUtil, FormDialog2, AuiTabs, jQuery, exports, parseUri) {
  'use strict';
  ...
  exports.init = function () {
    jQuery(document).delegate(workflowLinkSelector, "click", function (event) {
      ...
      var id = "workflow-transition-".concat(action, "-dialog");
       ...
       * @ignore
       */
      DialogRegister[id] = new FormDialog2({
        id: id,
        widthClass: "large",
