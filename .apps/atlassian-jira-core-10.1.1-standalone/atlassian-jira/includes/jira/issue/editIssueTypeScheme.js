 ...
 */
require(['jira/analytics', 'jira/dialog/form-dialog2', 'aui/params', 'underscore', 'jquery', 'jira/util/logger'], function (analytics, FormDialog2, params, _, jQuery, logger) {
  'use strict';

  var PARAMS = [{
    selector: "#issue-type-scheme-name",
    name: "schemeName"
  }, {
    selector: "#issue-type-scheme-description",
    name: "schemeDescription"
  }, {
    selector: "input[name='fieldId']",
    name: "fieldId"
  }, {
    selector: "input[name='schemeId']",
    name: "schemeId"
  }, {
    selector: "input[name='projectId']",
    name: "projectId"
  }, {
    selector: "#default-issue-type-select",
    name: "defaultOption"
  }];
  ...
  function editIssueTypeScheme() {
    ...
    jQuery('#add-new-issue-type-to-scheme').attr('formDialogBound', '1');
    restrictOptions();
    logger.trace('jira.edit.issuetypescheme.initialized');
  }
