 ...
 * The JS consumes JSON data generated by WRM containing all subtask types from this jira instance. The WRM data key is "jira.core:jira-bulk-edit-data.subtaskIds"
 */
(function () {
  'use strict';
  ...
  var subtaskIds = wrmData.claim('jira.core:jira-bulk-edit-data.subtaskIds') || [];
