 ...
 **/
require(['jira/data/local-storage', 'jira/dialog/dialog-register', 'jira/dialog/dialog-util', 'jira/dialog/form-dialog2', 'jira/terminology-feature-service', 'jira/util/formatter', 'jira/util/init-on-dcl', 'jquery'], function (jiraLocalStorage, DialogRegister, DialogUtil, FormDialog2, terminologyFeatureService, formatter, initOnDCL, $) {
  'use strict';
  ...
  initOnDCL(function () {
    ...
    DialogRegister.terminologyHelp = new FormDialog2({
    ...
    DialogRegister.terminologyHelp.onContentReady(function () {
      var _this = this;
      this.get$popup().find('#terminology-dismiss-btn').on('click', function () {
    ...
    var $newLozenge = $("<span class=\"aui-lozenge aui-lozenge-subtle aui-lozenge-new\">".concat(formatter.I18n.getText('jira.terminology.help.new'), "</span>")).css('margin-left', '5px') // too lazy to make a css file just for this :notsureif:
