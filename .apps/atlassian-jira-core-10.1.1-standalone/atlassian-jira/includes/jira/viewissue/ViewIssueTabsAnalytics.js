define("jira/viewissue/tabs/analytics", ['jira/analytics', 'jira/util/strings', 'jira/viewissue/analytics-utils', 'underscore'], function (analytics, StringUtils, AnalyticsUtils, _) {
  'use strict';
