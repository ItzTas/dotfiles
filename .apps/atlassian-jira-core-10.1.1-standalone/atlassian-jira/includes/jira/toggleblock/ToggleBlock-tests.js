AJS.test.require(["jira.webresources:toggle-block"], function () {
  ...
  [{
    ...
    test("".concat(spec.name), function () {
      var _this = this;
      // given
  ...
  [{
    ...
    test("Should ignore an invalid id: ".concat(spec.id), function () {
      // given
  ...
  [{
    ...
    test("Should add the id=".concat(spec.id, " to the storage with initial content: ").concat(spec.storageIn), function () {
      // given
  ...
  [{
    ...
    test("Should remove the id=".concat(spec.id, " from the storage with initial content: ").concat(spec.storageIn), function () {
      // given
      this.getItemMock.returns(spec.storageIn);
      this.setItemMock.reset();
  ...
  [{
    ...
    test("Should filter out incorrect values on save from the storage with initial content: ".concat(spec.storageIn), function () {
      // given
      this.getItemMock.returns(spec.storageIn);
      this.setItemMock.reset();
