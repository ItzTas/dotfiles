define('jira/wikipreview/wiki-preview', ['jira/util/formatter', 'wrm/context-path', 'jquery'], function (formatter, contextPath, jQuery) {
  ...
  return function wikiPreview(prefs, ctx) {
     ...
     * @private
     */
    var toggleRenderPreview = function toggleRenderPreview() {
      if (!inPreviewMode) {
    ...
    var changePreviewAccessibleTextTo = function changePreviewAccessibleTextTo(accessibleText) {
    ...
    var handleError = function handleError(previewer) {
