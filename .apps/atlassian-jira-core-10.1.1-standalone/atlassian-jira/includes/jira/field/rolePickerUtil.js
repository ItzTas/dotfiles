define('jira/field/role-picker-util', ['jquery', 'jira/ajs/list/group-descriptor', 'jira/ajs/list/item-descriptor'], function ($, GroupDescriptor, ItemDescriptor) {
  "use strict";
  ...
  RolePickerUtil.formatResponse = function (data) {
    ...
    $(data).each(function (i, suggestions) {
      var groupDescriptor = new GroupDescriptor({
        weight: i,
        // order of roles in suggestions dropdown
