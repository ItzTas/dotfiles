...
define('jira/message', ['jira/flag', 'jquery', 'jira/message/templates', 'jira/data/local-storage'], function (flag, jQuery, Templates, store) {
  ...
  var showMsgOnReload = function () {
    ...
    jQuery(function () {
      ...
      if (msg) {
        ...
        var messageTypes = {
          WARNING: {
            soyTemplate: Templates.warningMsg,
            auiType: 'warning'
          },
          ERROR: {
            soyTemplate: Templates.errorMsg,
            auiType: 'error'
          },
          SUCCESS: {
            soyTemplate: Templates.successMsg,
            auiType: 'success'
          },
          INFO: {
            soyTemplate: Templates.infoMsg,
            auiType: 'info'
          }
        };
  ...
  function showErrorMsg(msg, options) {
    return showMsg(msg, jQuery.extend({}, options, {
      type: 'error'
    }));
  }
