define('jira/legacy/meta', ['require', 'exports'], function (require, exports) {
  ...
  deprecator.prop(exports, 'getLoggedInUser', {
    sinceVersion: '7.0',
    removeInVersion: '8.0',
    alternativeName: 'module:jira/util/users/logged-in-user'
  });
  deprecator.prop(exports, 'getProject', {
    sinceVersion: '7.0',
    removeInVersion: '8.0'
  });
  deprecator.prop(exports, 'getIssueKey', {
    sinceVersion: '7.0',
    removeInVersion: '8.0',
    alternativeName: 'module:jira/issue'
  });
});
