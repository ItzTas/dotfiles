  ...
  setTimeout(function () {
     ...
     */
    {
      if (window.performance && window.performance.mark) {
        window.performance.mark('defer_scripts_clicks', {
          detail: {
            count: window.DeferScripts.totalClicks
          }
        });
        window.performance.mark('defer_scripts_keydowns', {
          detail: {
            count: window.DeferScripts.totalKeydowns
          }
        });
