...
require(["jquery", "jira/setup/init-setup-page", "jira/setup/setup-account-view", "jira/setup/setup-finishing-layout", "jira/setup/setup-database-view", "jira/setup/setup-license", "jira/setup/setup-tracker"], function ($, initSetupPage, SetupAccountView, SetupFinishingLayout, SetupDatabaseView, SetupLicense, SetupTracker) {
  "use strict";
