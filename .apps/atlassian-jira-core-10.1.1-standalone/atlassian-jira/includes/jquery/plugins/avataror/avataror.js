jQuery.fn.avataror = function (options) {
  ...
  this.each(function () {
    ...
    avataror.preview = $("<div/>").addClass("avataror-preview").css({
      border: "solid 1px #000",
      "float": "left",
      height: avataror.previewSize + "px",
      overflow: "hidden",
      width: avataror.previewSize + "px",
      position: "relative",
      top: "-9999em",
      left: "-9999em"
    });
    ...
    avataror.img.load(function () {
      ...
      avataror.image.css({
        width: avataror.imgwidth + "px",
        height: avataror.imgheight + "px"
      });
      avataror.setMarker();
      $this.css({
        width: avataror.imgwidth + "px"
    ...
    avataror.nwHandler = function (dx, dy) {
      ...
      var tmpBase = {
        x: avataror.originX() + dx,
        y: avataror.originY() + dy
      };
