...
(function ($) {
  var style = document.documentElement.style,
    ...
    domSplit = function domSplit(root, maxIndex, options) {
      var index = 0,
        result = [],
        domSplitAux = function domSplitAux(nodes) {
          var i = 0,
            tmp,
            clipIndex = 0;
          if (index > maxIndex) {
  ...
  $.extend($.fn, {
    textOverflow: function textOverflow(options) {
      var o = $.extend({
        str: '&#x2026;',
        autoUpdate: false,
        trim: true,
