  ...
  module('AJS.namespace deprecations (all browsers)', {
    setup: function setup() {
      this.config = {
        ...
        // NOTE: testing browser-independent behaviour by default
        logDeprecationNotice: true,
        // NOTE: This is on now by default for our tests
        noGlobals: false
      };
      this.logger = sinon.spy();
      this.context = AJS.test.mockableModuleContext();
    ...
    module('AJS.namespace deprecations (Object.defineProperty)', {
      setup: function setup() {
        this.config = {
          ...
          // NOTE: we'll make use of Object.defineProperty.
          logDeprecationNotice: true,
          // NOTE: This is on now by default for our tests
          noGlobals: false
        };
