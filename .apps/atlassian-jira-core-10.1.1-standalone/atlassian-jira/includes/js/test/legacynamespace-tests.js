AJS.test.require(["jira.webresources:jqlautocomplete", "jira.webresources:ajax-favourite-control", "jira.webresources:userprofile", "jira.webresources:jira-global"], function () {
  'use strict';

  var ensureOldNamespaceCallsNew = function ensureOldNamespaceCallsNew(oldNamespaceStr, newNamespaceStr) {
