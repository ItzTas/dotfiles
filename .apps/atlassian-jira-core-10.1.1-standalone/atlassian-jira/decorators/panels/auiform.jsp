...
Optional Parameters:
    ...
    * ariaRole                              - a11y "role" (ARIA role) status for the form
    * displayWarnings                       - whether or not display warning messages (the webwork action must implement WarningsAwareAction)
...
<form action="<decorator:getProperty property="action" />"
      ...
      <% if (p.isPropertySet("formName")) { %>name="<decorator:getProperty property="formName" />"<% } %>
      <% if (p.isPropertySet("ariaRole")) { %>role="<decorator:getProperty property="ariaRole" />"<% } %>
    ...
    <div class="form-body">
            ...
            <aui:component template="auimessage.jsp" theme="'aui'">
                ...
                <aui:param name="'messageHtml'">
                    <ww:iterator value="flushedErrorMessages">
                        <% if (p.getBooleanProperty("errorMessagesEscapeSkip")) { %>
        ...
        <% } %>
        <% if (p.getBooleanProperty("displayWarnings")) { %>
        <ww:if test="hasWarningMessages == 'true'">
            <aui:component template="auimessage.jsp" theme="'aui'">
                <aui:param name="'messageType'">warning</aui:param>
                <aui:param name="'messageHtml'">
                    <ww:iterator value="flushedWarningMessages">
                        <p><ww:property /></p>
                    </ww:iterator>
                </aui:param>
            </aui:component>
        ...
        <div class="buttons">
            ...
            <% if (p.isPropertySet("submitButtonText")) { %>
                <aui:component template="formSubmit.jsp" theme="'aui'">
                    ...
                    <aui:param name="'formId'"><decorator:getProperty property="id" /></aui:param>
