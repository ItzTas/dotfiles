...
| Bash / POSIX sh (`.sh`, `.bash`, or a `bash`/`sh` shebang)                                                            | `~/.claude/rules/linters/bash.md`       |
| Zsh (`.zsh`, `.zshrc`/`.zshenv`, or a `zsh` shebang)                                                                  | `~/.claude/rules/linters/zsh.md`        |
| Tailwind-style utility classes (Tailwind or UnoCSS `presetWind*`, in `.svelte`/`.html`/`.jsx`/`.tsx`/`.vue`/`.astro`) | `~/.claude/rules/linters/tailwind.md`   |
