---
description: Load my cross-project work rule — read the target project's CLAUDE.md before making changes in a repository/project other than the current one
---
