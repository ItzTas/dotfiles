...
This command exists precisely to honor my `~/.claude/rules/git-conventions.md` rule of never working directly on a
...
- Follow my code style rules in `~/.claude/rules/code-style.md` (guard clauses over nesting, a map over `switch`/`if-else` for
...
- **Otherwise,** commit the changes following my `~/.claude/rules/git-conventions.md` rules: atomic commits, Conventional
