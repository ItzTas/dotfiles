...
- **`major`** — allow major-version bumps. Without it, `update` stays on **safe (minor/patch)**
  ranges only.
...
### 3. Audit (always — this is the reporting part)
...
### 5. Summary
- Show what was audited, what was updated (from→to versions), the state of remaining
