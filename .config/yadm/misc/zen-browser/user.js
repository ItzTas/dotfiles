...
user_pref('privacy.clearOnShutdown.cache', true); // Clears cache automatically when browser is closed
...
// ==== Beacon ====
user_pref('beacon.enabled', false); // Blocks the Beacon API, which sends data when leaving pages
