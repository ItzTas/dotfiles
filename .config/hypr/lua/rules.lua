...
rule({
	name = "misc-apps",
	match = {
		class = "Lxappearance|ncmpcpp|Rofi|pavucontrol-qt|gucharmap|gnome-font|org.gnome.Settings|file-roller|obs|wdisplays|keepassxc|imFile|clipse-gui|confirmreset",
	},
	float = true,
})
...
rule({
	name = "media-titles",
	match = {
		title = "^(Media viewer)$|^(Transmission)$|^(Volume Control)$|^(Picture-in-Picture)$|^(Winetricks)(.*)?$|^(Steam Achievement Notifier \\(V1\\.9\\): Notification)$",
	},
	float = true,
})
