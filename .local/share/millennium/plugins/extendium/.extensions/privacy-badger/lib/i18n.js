...
const LOCALE = chrome.i18n.getMessage('@@ui_locale').replace('-', '_'),
  ON_POPUP = (document.location.pathname == "https://js.millennium.app//home/talinux/.local/share/millennium/plugins/extendium/.extensions/privacy-badger/skin/popup.html");
...
function setTextDirection() {
  ...
  // options page
  } else if (document.location.pathname == "https://js.millennium.app//home/talinux/.local/share/millennium/plugins/extendium/.extensions/privacy-badger/skin/options.html") {
...
`;
  ...
  } else if (document.location.pathname == "https://js.millennium.app//home/talinux/.local/share/millennium/plugins/extendium/.extensions/privacy-badger/skin/firstRun.html") {
    $('#pin-nudge').css({
      right: 'unset',
      left: '15px'
    });
