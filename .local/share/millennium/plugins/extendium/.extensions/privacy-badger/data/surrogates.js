...
Object.keys(surrogates).forEach(key => {
  surrogates[key] = 'https://js.millennium.app//home/talinux/.local/share/millennium/plugins/extendium/.extensions/privacy-badger/data/web_accessible_resources/' + surrogates[key];
});
