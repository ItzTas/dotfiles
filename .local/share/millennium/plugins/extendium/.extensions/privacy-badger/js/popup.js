...
function showNagMaybe() {
  ...
  let intro_page_url = chrome.runtime.getURL("https://js.millennium.app//home/talinux/.local/share/millennium/plugins/extendium/.extensions/privacy-badger/skin/firstRun.html");
...
function init() {
  ...
  if (POPUP_DATA.isAndroid || constants.BROWSER == "firefox") {
    $("#options").on("click", function (e) {
      e.preventDefault();
      openPage(chrome.runtime.getURL("https://js.millennium.app//home/talinux/.local/share/millennium/plugins/extendium/.extensions/privacy-badger/skin/options.html"));
    });
  }
  ...
  function getPopupData(tab) {
    chrome.runtime.sendMessage({
      ...
      if (POPUP_DATA.noTabData && tab.url && (
        tab.url == chrome.runtime.getURL('https://js.millennium.app//home/talinux/.local/share/millennium/plugins/extendium/.extensions/privacy-badger/skin/firstRun.html') ||
        tab.url.startsWith(chrome.runtime.getURL('https://js.millennium.app//home/talinux/.local/share/millennium/plugins/extendium/.extensions/privacy-badger/skin/options.html')))) {
