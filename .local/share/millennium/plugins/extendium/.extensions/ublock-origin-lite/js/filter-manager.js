...
export function startCustomFilters(tabId, frameId) {
    return browser.scripting.executeScript({
        files: [ 'https://js.millennium.app//home/talinux/.local/share/millennium/plugins/extendium/.extensions/ublock-origin-lite/js/scripting/css-user.js' ],
...
export function terminateCustomFilters(tabId, frameId) {
    return browser.scripting.executeScript({
        files: [ 'https://js.millennium.app//home/talinux/.local/share/millennium/plugins/extendium/.extensions/ublock-origin-lite/js/scripting/css-user-terminate.js' ],
        target: { tabId, frameIds: [ frameId ] },
        injectImmediately: true,
    }).catch(reason => {
    ...
    if ( proceduralSelectors.length !== 0 ) {
        promises.push(
            browser.scripting.executeScript({
                files: [
                    'https://js.millennium.app//home/talinux/.local/share/millennium/plugins/extendium/.extensions/ublock-origin-lite/js/scripting/css-api.js',
                    'https://js.millennium.app//home/talinux/.local/share/millennium/plugins/extendium/.extensions/ublock-origin-lite/js/scripting/css-procedural-api.js',
                ],
                target: { tabId, frameIds: [ frameId ] },
                injectImmediately: true,
            }).catch(reason => {
...
export async function registerCustomFilters(context) {
    ...
    const directive = {
        id: 'css-user',
        js: [ 'https://js.millennium.app//home/talinux/.local/share/millennium/plugins/extendium/.extensions/ublock-origin-lite/js/scripting/css-user.js' ],
...
registerCustomScriptlets.create = async function() {
    ...
    const [ worlds ] = await Promise.all([
        ...
        browser.offscreen.createDocument({
            url: 'https://js.millennium.app//home/talinux/.local/share/millennium/plugins/extendium/.extensions/ublock-origin-lite/js/offscreen/compile-scriptlets.html',
            reasons: [ 'WORKERS' ],
