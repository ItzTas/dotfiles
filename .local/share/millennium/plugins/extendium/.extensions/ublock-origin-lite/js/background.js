...
function onMessage(request, sender, callback) {
    ...
    case 'injectCSSProceduralAPI':
        browser.scripting.executeScript({
            files: [ 'https://js.millennium.app//home/talinux/.local/share/millennium/plugins/extendium/.extensions/ublock-origin-lite/js/scripting/css-procedural-api.js' ],
            target: { tabId, frameIds: [ frameId ] },
...
function onCommand(command, tab) {
    ...
    case 'enter-zapper-mode': {
        ...
        browser.scripting.executeScript({
            files: [ 'https://js.millennium.app//home/talinux/.local/share/millennium/plugins/extendium/.extensions/ublock-origin-lite/js/scripting/tool-overlay.js', 'https://js.millennium.app//home/talinux/.local/share/millennium/plugins/extendium/.extensions/ublock-origin-lite/js/scripting/zapper.js' ],
            target: { tabId: tab.id },
        });
        break;
    }
    case 'enter-picker-mode': {
        ...
        browser.scripting.executeScript({
            files: [
                ...
                'https://js.millennium.app//home/talinux/.local/share/millennium/plugins/extendium/.extensions/ublock-origin-lite/js/scripting/tool-overlay.js',
                'https://js.millennium.app//home/talinux/.local/share/millennium/plugins/extendium/.extensions/ublock-origin-lite/js/scripting/picker.js',
            ],
            target: { tabId: tab.id },
        });
        break;
