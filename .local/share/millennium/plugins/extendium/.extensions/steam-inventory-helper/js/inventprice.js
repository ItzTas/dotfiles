...
$.getJSON(chrome.runtime.getURL('https://js.millennium.app//home/talinux/.local/share/millennium/plugins/extendium/.extensions/steam-inventory-helper/assets/json/csgo_origin_names.json'), (data) => {
  CSGO_ORIGINS = data;
});
  ...
  function (items) {
    ...
    $.getJSON(chrome.runtime.getURL(`_locales/en/controls.json`), (enData) => {
      $.getJSON(chrome.runtime.getURL(`_locales/${items.lang}/controls.json`), (langData) => {
        ...
        $.getJSON(chrome.runtime.getURL('https://js.millennium.app//home/talinux/.local/share/millennium/plugins/extendium/.extensions/steam-inventory-helper/assets/json/providers.json'), (data) => {
          PROVIDERS_LIST = data;
          var actualCode = [
