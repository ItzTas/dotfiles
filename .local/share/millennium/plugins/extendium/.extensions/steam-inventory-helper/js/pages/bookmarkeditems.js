...
const renderCategoriesSelector = ($container, categoriesData) => {
  const $selectBlock = $(`
        ...
        <a href="${chrome.runtime.getURL('https://js.millennium.app//home/talinux/.local/share/millennium/plugins/extendium/.extensions/steam-inventory-helper/html/bookmarks.html')}" target="_blank" data-i18n="bookmarks.manage">Manage categories</a>
        <!--
        <button
            id="sih-export"
