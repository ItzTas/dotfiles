...
const pluginName = "browser_history";
...
let PluginEntryPointMain = function() { var millennium_main=function(e,n){"use strict";!function(){const e={};try{if(process)return process.env=Object.assign({},process.env),void Object.assign(process.env,e)}catch(e){}globalThis.process={env:e}}();const t="SP Desktop_uid0";async function o(e){if(e.m_strName!==t)return;const o=n.findModule(e=>e.FocusBar),a=await(async(e,t=document)=>[...await n.Millennium.findElement(t,e)][0])(`.${o.URLBarText}`,e.m_popup.document);let s=[];MainWindowBrowserManager.m_browser.on("start-request",e=>{e.startsWith("data")||s.includes(e)||s.unshift(e)}),a.addEventListener("click",()=>{n.showContextMenu(window.SP_REACT.createElement(n.Menu,{label:"History"},s.map(e=>window.SP_REACT.createElement(n.MenuItem,{onClick:()=>{MainWindowBrowserManager.ShowURL(e)}},e))),a,{bForcePopup:!0,bOverlapHorizontal:!0})})}return e.default=async function(){const e=g_PopupManager.GetExistingPopup(t);e&&o(e),g_PopupManager.AddPopupCreatedCallback(o)},Object.defineProperty(e,"__esModule",{value:!0}),e}({},window.MILLENNIUM_API);
